        ...
        public static void ParametersToConfiguration(Form1 fm, string mypath)
        {
            try
            {
                ...
                cdsxml.LoadXml(
                    ...
                    "<BatteryMaximumVoltage_36V>" +
                    Form1.gss_BatteryMaximumVoltage_36V +
                    "</BatteryMaximumVoltage_36V>" +

                    "<BatteryMinimumVoltage_36V>" +
                    Form1.gss_BatteryMinimumVoltage_36V +
                    "</BatteryMinimumVoltage_36V>" +

                    "<SoftwareVersion>" +
                    Form1.gss_SoftwareVersion +
                    "</SoftwareVersion>" +

                    "<HardwareVersion>" +
                    Form1.gss_HardwareVersion +
                    "</HardwareVersion>" +

                    "<ProductModel>" +
                    Form1.gss_ProductModel +
                    "</ProductModel>" +

                    "<MotorSeries>" +
                    Form1.gss_MotorSeries +
                    "</MotorSeries>" +

                    "<SamePolarity>" +
                    Form1.gss_SamePolarity +
                    "</SamePolarity>" +

                    "<ProtectionTemperature>" +
                    Form1.gss_ProtectionTemperature +
                    "</ProtectionTemperature>" +
