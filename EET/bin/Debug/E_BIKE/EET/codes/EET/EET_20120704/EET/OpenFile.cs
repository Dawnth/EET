    ...
    class OpenFile
    {
        ...
        public static void OpenConfigurationFile(Form1 fm, string mypath)
        {
            try
            {
                ...
                if (File.Exists(mypath))
                {
                    ...
                    // 加载到界面
                    GenerateParameters.ParametersToUI(fm);
                    // 总校验
                ...
                else
                {
                    ...
                    File.Delete(fm.EET_openFileDialog.FileName);
                    SaveFile.ParametersToConfiguration(fm, fm.EET_openFileDialog.FileName);
                }
            }
            catch (Exception ex)
            {
        ...
        public static void ConfigurationToParameters(string mypath)
        {
            ...
            if (configNode != null)
            {
                ...
                // 最新更新的参数，根据文档增加
                Form1.gss_MotorType_Select = configNode.ChildNodes.Item(62).InnerText.ToString();
                ...
                Form1.gss_LockedRotorCurrentDrop_Select = configNode.ChildNodes.Item(66).InnerText.ToString();
                Form1.gss_LockedRotorCurrentDrop = configNode.ChildNodes.Item(67).InnerText.ToString();
                Form1.gss_HandBrakeOverrun_Select = configNode.ChildNodes.Item(68).InnerText.ToString();
                Form1.gss_HandBrakeOverrun = configNode.ChildNodes.Item(69).InnerText.ToString();
                Form1.gss_SlideCharge_Select = configNode.ChildNodes.Item(70).InnerText.ToString();
                ...
                Form1.gss_MotorSeries = configNode.ChildNodes.Item(77).InnerText.ToString();
                Form1.gss_SamePolarity = configNode.ChildNodes.Item(78).InnerText.ToString();
                Form1.gss_ProtectionTemperature = configNode.ChildNodes.Item(79).InnerText.ToString();
                Form1.gss_Hall = configNode.ChildNodes.Item(80).InnerText.ToString();
            }
        }
    }
}
